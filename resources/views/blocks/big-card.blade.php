<div class="{{ $block->classes }}">
  <div class="grid items-center justify-center grid-cols-1 big-card xl:grid-cols-2 big-card-block">
    <div class="flex flex-col justify-center h-full gap-12 first-col">
      ...
      {{-- Button --}}
      <a class="text-center mb-12 xl:mb-0 font-jost text-lg text-white hover:text-primary flex items-center justify-center gap-3 transition-all w-full xl:w-1/3 bg-secondary rounded-[18px] p-7" href="{{ $link }}" target="_blank">
        {{ $link_text }}
